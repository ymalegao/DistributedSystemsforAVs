...
// Scoped inside our namespace, never at global scope: this file is written
// against Veins TraCI types and reads far better unqualified, but an includer
// must not inherit the directive.
