...
ConsensusManagerPBFT::~ConsensusManagerPBFT() {
  // Stop() sets IsRunning()=false; recovery_thread_ unblocks from Pop() within
  // its 100ms timeout and exits. Join here to prevent std::terminate() on
  // destruction of a joinable std::thread.
