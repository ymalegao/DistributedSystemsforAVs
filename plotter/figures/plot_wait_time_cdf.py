...
from plotter.io.partner_metrics_io import PARTNER_ROOT, partner_run_metrics, partner_wait_time_samples_s
from plotter.io.benchmark_metrics_io import metric_json_paths, load_wait_samples_from_metric_jsons
...
def plot_ambulance_vs_normal_wait(
    ...
    for ax_idx, vc in enumerate(GRID_VEHICLE_COUNTS):
        ...
        if include_partner:
            from plotter.io.partner_metrics_io import partner_priority_and_normal_wait_means_s, partner_wait_time_samples_s
...
def main() -> int:
    ...
    base_dir = args.base_dir.resolve() if args.base_dir else repo_root / "benchmarks"
