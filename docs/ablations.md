...
([conflict_matrix.png](../figures/conflict_matrix.png) + `../benchmarks/ablations/conflict_matrix.md`).

Regenerate: inside `opp_env`, `benchmarks/ablations/run_ablations.sh <n|all> [reps]`
to produce `benchmarks/ablations/results/`, then `python3 -m plotter build-all`,
which writes PNGs to `figures/`. (The old `analyze_ablations.py` and
`conflict_matrix.py` were replaced by the `plotter` package.)

---

## 1. With / without RSU units — [ab1_rsu.png](../figures/ab1_rsu.png)
...
## 2. Vanilla BFT vs our BFT — [ab2_attack.png](../figures/ab2_attack.png)
...
## 3. All-way-stop baseline vs our protocol — [ab3_baseline.png](../figures/ab3_baseline.png)
...
## 4. With / without priority — [ab4_priority.png](../figures/ab4_priority.png)
...
## 5. With / without rollback — [ab5_rollback.png](../figures/ab5_rollback.png)
...
## 6. Vanilla BFT vs our BFT (baseline) — [ab6_vanilla_vs_ours.png](../figures/ab6_vanilla_vs_ours.png)
...
## Latency decomposition (for understanding) — [decomposition.png](../figures/decomposition.png)
...
## Conflict matrix (definition) — [conflict_matrix.png](../figures/conflict_matrix.png) + [../conflict_matrix.md](../conflict_matrix.md)
